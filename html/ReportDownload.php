...
<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
    ...
    <section class="section section-cta parallax" style="background-image: url(images/ProjectImages/bg.jpg);">
        <div class="container">
            ...
            <a href="DownloadReport.php" name="ReportButton" class="btn btn-medium btn-yellow js-wave" style="margin-top:120px;">Download Report</a>
        </div>
    </section>
    <!--/ Call To Action -->
                            ...
                            <div class="testimonials-slider">
                                <article class="testimonial">
                                    <blockquote class="testimonial-quote">
                                        On behalf of the Save Our Sick Kids Foundation (SOS Kids), I would like to thank you for the International Foundation for Progress contribution of $13,650.00 received on October 8, 2013. Your generous financial support assists in our outreach and educational efforts to eradicate deadly infections in children with cancer.<br>
SOS Kids was established to raise awareness and improve the treatment of infections affecting children left vulnerable from cancer treatment. Every year over 10,000 children are diagnosed with cancer in the United States. Of those, nearly 10% die from an infection due to their compromised immune systems. Thousands of the survivors are left maimed by the ravages of infections that their bodies are unable to fight.<br>
Through its outreach and educational programs, SOS Kids has a positive effect on these children and their families. Your contribution will help make an important difference in the outcomes of children already fighting for their lives. Your donation literally saves life and limb.
                                    ...
                                    <div class="testimonial-author">
                                        ...
                                        <div class="name">Aleks Nikolich</div>
